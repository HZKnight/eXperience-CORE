<?php if(!class_exists('RainTPL\RainTPL', false)){exit;}?><!DOCTYPE html>
    ...
    <body>
        ...
        <nav class="uk-navbar-container">
            <div class="uk-container uk-container-expand">
                <div uk-navbar>
                    <a class="uk-navbar-item uk-logo" href="#" aria-label="Back to Home">eXperience CORE <?php echo $version;?> - Test application</a>
                </div>
            </div>
        </nav>
